...
<head>
  ...
  <title>🌟 GlasWeld — Ứng Dụng Công Nghệ LED UV Trong Sửa Kính Ô Tô</title>
  <meta name="description" content="GlasWeld ứng dụng công nghệ LED UV tiên tiến trong phục hồi kính ô tô: hàn kính nhanh, bền, thẩm mỹ cao và an toàn. Liên hệ: 0337 749 560.">
  <meta name="keywords" content="GlasWeld, LED UV, hàn kính ô tô, phục hồi kính, sửa kính Nha Trang">
  <link rel="icon" href="https://upload.wikimedia.org/wikipedia/commons/9/91/Icon_of_Zalo.svg">

  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "GlasWeld LED UV — Hàn Kính Ô Tô",
    "provider": {
      "@type": "LocalBusiness",
      "name": "Hàn Kính Ô Tô Nha Trang",
      "telephone": "+84337749560",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Khu Tái định cư Bầu Gáo",
        "addressLocality": "Diên Khánh",
  ...
  <style>
    :root{--brand:#005a46;--accent:#ffb400;--bg:#f7faf8;--card:#fff;--muted:#556;--cta:#28a745;--ui:60px}
    *{box-sizing:border-box}
    body{margin:0;font-family:Inter, 'Segoe UI', Roboto, system-ui, Arial; background:var(--bg);color:#0f1f1a}
    header{background:linear-gradient(135deg,var(--brand),#0a8060);color:#fff;padding:44px 16px;text-align:center}
    header h1{margin:0;font-size:1.5rem}
    header p{margin:.6rem 0 0;opacity:.95}
    .container{max-width:1100px;margin:-36px auto 40px;background:var(--card);padding:26px;border-radius:12px;box-shadow:0 16px 36px rgba(4,10,8,0.06)}
    .hero{display:grid;grid-template-columns:1fr 340px;gap:20px;align-items:start}
    @media(max-width:880px){.hero{grid-template-columns:1fr}}
    .badge{background:#eafbf5;border-left:4px solid var(--brand);padding:12px 14px;border-radius:10px}
    h2{color:var(--brand);font-size:1.15rem;margin-top:20px;border-left:4px solid var(--accent);padding-left:10px}
    p.lead{color:#0b2e21;margin-top:12px}
    ul{margin:8px 0 0 1.1rem}
    .cta-card{padding:16px;border-radius:12px;background:linear-gradient(180deg,#fff,#f8fffb);text-align:center;box-shadow:0 6px 18px rgba(3,10,10,0.04)}
    .phone{display:block;font-weight:800;font-size:1.2rem;color:var(--brand);margin:10px 0}
    .btn{display:inline-flex;gap:10px;align-items:center;padding:10px 12px;border-radius:10px;text-decoration:none;font-weight:700}
    .btn-zalo{background:#0068ff;color:#fff}
    .btn-call{background:var(--cta);color:#fff}
    footer{margin-top:24px;text-align:center;color:var(--muted);padding:16px;border-top:1px solid #eef}
    .float-rail{position:fixed;right:16px;top:50%;transform:translateY(-50%);display:flex;flex-direction:column;gap:12px;z-index:9999}
    .float-rail a{width:var(--ui);height:var(--ui);display:inline-grid;place-items:center;border-radius:999px;color:#fff;text-decoration:none;box-shadow:0 10px 26px rgba(2,10,8,0.12)}
    .float-rail .zalo{background:#0068ff}
    .float-rail .call{background:var(--cta);position:relative}
    .call::after{content:'';position:absolute;inset:0;border-radius:999px;box-shadow:0 0 0 6px rgba(40,167,69,0.12);animation:pulse 1.8s infinite}
